...
FORCESUB_CHANNEL = int(os.environ.get("FORCESUB_CHANNEL", "-1001938180288"))
FORCESUB_CHANNEL2 = int(os.environ.get("FORCESUB_CHANNEL2", "-1002070031292"))
FORCESUB_CHANNEL3 = int(os.environ.get("FORCESUB_CHANNEL3", "-1002028196344"))
...
CUSTOM_CAPTION = os.environ.get("CUSTOM_CAPTION", "<b>» ʙʏ @Call_me_futurepilot</b>")
